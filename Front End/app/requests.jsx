  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch all pending connection requests
    ...
    try {
      ...
      const { error: connectionError } = await supabase
        ...
        .insert([
          ...
          //{ user_id: request.requester_id, connected_user_id: request.requested_id },
        ]);
            ...
            renderItem={({ item }) => (
              <View style={styles.requestCard}>
                <Text style={styles.requesterName}>
                  {item.requester?.name || 'Unknown User'} wants to connect!
                </Text>
